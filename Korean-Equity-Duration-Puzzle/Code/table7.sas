...
select b.code, b.kospi200, a.date, a.owner, a.dy, a.p_return, a.bps, a.eps, a.rate
...
proc reg data=reg14;
model owner1=dy rate bps2 eps2 p_return kospi200/vif;
run;

proc panel data=reg11;
model owner1=dy dyrate/fixonetime;
id code date;
run;
